...
public class URIHandler {
    ...
    public static String doGet(String uri,String failure) {
        ...
        try {
            ...
            Log.d("AndroidQOD","Received: " + result);
            return result;

        } catch(Exception ex) {
            Log.d("AndroidQOD","Exception in doGet: "+ex.getMessage());
        } finally {
            if (is != null) {
                try {
                    is.close();
    ...
    public static String doPost(String uri, String data) {
        ...
        try {
            Log.d("AndroidQOD","Post uri: " + uri);
            URL url = new URL(uri);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("POST");
            Log.d("AndroidQOD","Posted: " + data);
            conn.setDoInput(true);
    ...
    public static void doDelete(String uri) {
        try {
            Log.d("AndroidQOD","DELETE uri: " + uri);
            URL url = new URL(uri);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
